...
void main() {
  ...
  Timer.periodic(Duration(seconds: 3), (timer) {
    // Simula a distância entre o sensor ultrassônico e o nível da água.
    // Gera um valor aleatório entre 5 cm e a altura total do tanque.
    final distancia = 5.0 + Random().nextDouble() * tanque['altura'];

    // Calcula o nível de água no tanque:
    // Subtrai a distância medida da altura do tanque para obter a altura da água.
    ...
    if (percentual >= 75) {
      // Se o tanque estiver com 75% ou mais de água.
      status = "ALTO";
      cor = "\x1b[32m"; // Verde
    } else if (percentual >= 30) {
      // Se o tanque estiver entre 30% e 75% de água.
      status = "MÉDIO";
      cor = "\x1B[33m"; // Amarelo
    } else {
      // Se o tanque estiver com menos de 30% de água.
      status = "BAIXO";
